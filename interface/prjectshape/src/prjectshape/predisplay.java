...
public class predisplay {
	...
	void proo() {
		// display all instruction for calculate ,csa,tsa,volume
	...
	// selection process csa,tsa,volume
	 void csa_tsa(Shape c1){
		...
		}while (con);// when choose incorrect option the again start th function
     
     }
	
    void pre() {
   
	 //selection of 3-D figure
